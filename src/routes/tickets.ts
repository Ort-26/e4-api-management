...
import { validateCreateTicket, validateCreateTicketComment, validateTicketIdAgent, validateTicketIdParam, validateTicketIdStatus } from '../middleware/ticketValidators';
...
router.get('/', 
    requireAccessToken
    ,ticketInteractions.validateUserPermissions({ permissionIds: [AppTypes.PERMISSIONS.TICKET_READ_ALL] })
...
router.get('/:ticketId', 
    ...
    ,ticketInteractions.canInteractWithTicket({ permissionIds: [AppTypes.PERMISSIONS.TICKET_READ_ALL] })
...
router.post('/:ticketId/comments',
    ...
    ,ticketInteractions.canInteractWithTicket({ permissionIds: [
        AppTypes.PERMISSIONS.TICKET_READ_ALL,
...
router.post('/:ticketId/assign/:agentId',
    ...
    ,ticketInteractions.validateUserPermissions({ permissionIds: [AppTypes.PERMISSIONS.TICKET_ASSIGN] })
    ,ticketsController.assignAgentToTicket
);
